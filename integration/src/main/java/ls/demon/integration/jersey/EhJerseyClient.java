 ...
 */
package ls.demon.integration.jersey;
 ...
 */
public class EhJerseyClient implements JerseyClientConstants {

    /**
    * Logger for this class
    */
    private static final Logger       logger     = LoggerFactory.getLogger(JERSEY_LOGGER);
    ...
    static {
        ...
        CLIENT_CONFIG.property(ClientProperties.CONNECT_TIMEOUT, 5 * 1000);
        ...
        java.util.logging.Logger log = java.util.logging.Logger.getLogger(JERSEY_LOGGER);
    ...
    public static Client getSSLTrustJerseyClient(String keyStorePath, String keyStorePwd) {
        try {
            ...
            return ClientBuilder.newBuilder().sslContext(sslContext).withConfig(CLIENT_CONFIG)
                .build();
        } catch (Exception e) {
            logger.error("", e);
            return null;
